...
> [!IMPORTANT]
> M0 and M1 are complete. M2 is in progress, and its first payment-to-invoice amount-allocation slice has passed acceptance. The new system does not preserve v0.x compatibility or read or migrate legacy data.
