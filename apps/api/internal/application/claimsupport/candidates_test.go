...
func candidatePaymentEnvelope() domain.ClaimEnvelope {
	...
	return domain.ClaimEnvelope{SchemaVersion: "document-claim/4", DocumentType: "payment", DocumentIssues: []string{}, Fields: []domain.FieldCandidate{
...
func candidateInvoiceEnvelope() domain.ClaimEnvelope {
	evidence := []domain.CandidateEvidence{{Page: 1, Quote: "evidence"}}
	return domain.ClaimEnvelope{SchemaVersion: "document-claim/4", DocumentType: "invoice", DocumentIssues: []string{}, Fields: []domain.FieldCandidate{
