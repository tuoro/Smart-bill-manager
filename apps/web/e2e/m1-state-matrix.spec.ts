...
// 增值税发票是横版（240x140mm ≈ 1.71:1）。竖屏截图和横版发票对面板的要求正好
// 相反，一个固定列宽伺候不了两种版式，缩放与展开就是为此存在的。
const landscapePNG = Buffer.from(
  '',
  'base64',
)
...
test.describe('M1/M2 真实组件状态矩阵', () => {
  ...
  test('审核工作台：三档缩放各不相同，整页完整放得下', async ({ page }) => {
    await mockSession(page)
    const review = readyReview('job-zoom')
    await mockReview(page, review)
    await page.route(
      (url) => url.pathname.includes(`/documents/${review.job.document_id}`),
      (route) => route.fulfill({ status: 200, contentType: 'image/png', body: portraitPNG }),
    ...
    const measure = async () =>
      page
        .locator('.document-stage img')
        .first()
        .evaluate((element) => {
          const image = element as HTMLImageElement
          const box = image.getBoundingClientRect()
          const stage = image.closest('.document-stage')!.getBoundingClientRect()
          return {
            width: box.width,
            height: box.height,
            stage: stage.height,
    ...
    // 默认整页：整张票据一次看完，用来看全貌和定位证据。
    const page整页 = await measure()
    expect(page整页.height, '整页必须完整放进可视区').toBeLessThanOrEqual(page整页.stage)

    // 适应宽度：横向填满，比整页大，纵向滚动。
    await page.getByRole('button', { name: '适应宽度', exact: true }).click()
    const 宽度 = await measure()
    expect(宽度.width).toBeGreaterThan(page整页.width)

    // 原始大小：按扫描分辨率显示，不再缩小。
    await page.getByRole('button', { name: '原始大小', exact: true }).click()
    const 原始 = await measure()
    expect(Math.round(原始.width)).toBe(原始.natural)
    expect(原始.width).toBeGreaterThan(宽度.width)

    // 换页等于换一张图，缩放回到整页。
    await page.getByRole('button', { name: '整页', exact: true }).click()
    expect((await measure()).width).toBeCloseTo(page整页.width, 0)
  })

  test('审核工作台：横版发票可以展开到整幅宽度再收回并排', async ({ page }) => {
    await mockSession(page)
    const review = readyReview('job-landscape')
    await mockReview(page, review)
    await page.route(
      (url) => url.pathname.includes(`/documents/${review.job.document_id}`),
      (route) => route.fulfill({ status: 200, contentType: 'image/png', body: landscapePNG }),
    )
    await page.setViewportSize({ width: 1366, height: 768 })
    await page.goto(`/reviews/${review.job.id}`)
    await expect(page.locator('.review-grid')).toBeVisible()
    ...
    // 并排时横版发票只能画到六分之一，20 位号码约 3px 高，读不了。
    const 并排 = await scale()
    expect(并排).toBeLessThan(0.25)

    await page.getByRole('button', { name: '展开原件', exact: true }).click()
    expect(await scale(), '展开后应能读').toBeGreaterThan(0.45)
    await expect(page.locator('.review-grid')).toHaveAttribute('data-source-expanded', 'true')

    // 展开是临时动作，收起后必须回到并排——并排才是默认。
    await page.getByRole('button', { name: '收起原件', exact: true }).click()
    await expect(page.locator('.review-grid')).toHaveAttribute('data-source-expanded', 'false')
    const source = await page.locator('.source-panel').boundingBox()
    const fields = await page.locator('.fields-panel').boundingBox()
