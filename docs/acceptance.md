...
验收结果：2026-09-01 通过。16 个工具测试文件、固定版本流式成功/摘要失败路径、临时目录回收、默认与三目录自定义映射、`7476` 端口、安装生命周期顺序、Release Compose 规范化、13 文件确定性 Bundle 与 SHA-256、README 三种部署形式、34 个本地文档链接、敏感信息和 diff 检查全部通过；未启动容器，临时文件已清理。
