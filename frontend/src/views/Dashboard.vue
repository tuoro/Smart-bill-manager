    ...
    <template v-else>
        ...
        <div class="hero-right">
          <div class="hero-chip">
            ...
            <div class="chip-value">
              {{ formatMoney(data.payments.totalThisMonth) }}
            </div>
          </div>
          <div class="hero-chip">
            <div class="chip-label">
          ...
          <template #content>
            <div class="stat">
              <div class="stat-left">
                ...
                <div class="stat-value">
                  {{ formatMoney(data.invoices.totalAmount) }}
                </div>
              </div>
              <div class="stat-icon">
      ...
      <div class="grid grid-equal">
        ...
        <Card class="panel sbm-surface">
          ...
          <template #content>
            <div
              v-if="recentPaymentsLoading"
              class="loading-mini"
            >
              <ProgressSpinner style="width: 26px; height: 26px" />
              <div class="loading-text-mini">
                &#21152;&#36733;&#20013;...
              </div>
            </div>
            <div
      ...
      <div class="grid grid-equal">
        ...
        <Card class="panel sbm-surface source-panel">
          ...
          <template #content>
            <div
              v-if="Object.keys(data.invoices.bySource || {}).length > 0"
              class="source-grid"
            >
              <Card
              ...
              >
                <template #content>
                  <div class="source-title">
                    {{ getSourceLabel(source as string) }}
                  </div>
      ...
      <div class="grid">
        <Card class="panel col-span-2 sbm-surface">
          ...
          <template #content>
            <div
              v-if="data.email.monitoringStatus.length > 0"
              class="monitor-list"
            >
              <div
                v-for="(item, index) in data.email.monitoringStatus"
